...
# regardless of whatever dependencies get added
  ...
  zypper -n ref && \
  zypper -n install git-core openssh bash unzip curl ca-certificates-suse glibc-locale-base java-1_8_0-openjdk-headless openSUSE-release-tools-repo-checker openSUSE-release-tools-pkglistgen python2-pika xz && \
